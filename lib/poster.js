...
export const TYPE = {
  ...
  // from 72% down. Kicker, then the headline, then the paragraph.
  kickerY: 0.762,
  titleTop: 0.815,      // first title baseline
  titleSize: 0.088,     // Anton is condensed, so it carries at this size
  titleLead: 0.94,
  titleMax: 2,
  footGap: 0.026,       // between the headline and the paragraph
  footSize: 0.028,
  footLead: 1.42,
  footMax: 4,
  colophonY: 0.972,
  ...
  // Insurance only — the band is flat and empty by brief.
  scrim: 0.28,
  scrimAlpha: 0.14,
  scrimTop: 0,
  scrimTopAlpha: 0,
