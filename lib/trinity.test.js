...
function testTrinityM_adaptiveThresholds() {
  ...
  // First picks should be from the pad path (1000, 1001, 1002, 1003 by h² desc).
  const paperFirst4 = paperOut.slice(0, 4)
  const paperHits = paperFirst4.filter(c2 => [1000, 1001, 1002, 1003].includes(c2)).length
  assert(paperHits === 4,
    'trinity-m paper thresholds force pad-from-global-largest',
    `first-4 = ${paperFirst4}`)
}
