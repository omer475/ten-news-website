...
function testAdaptiveThresholds() {
  ...
  // Phoenix Phase 1.6 (2026-05-08) lowered floors from 15/5 to 3/2 to fix
  // power-user histograms that were deep-but-flat. Test asserts the new floors.
  t = adaptiveThresholds(50)
  assert(t.tP >= 3 && t.tS >= 2,
    'adaptiveThresholds respects floors (Phase 1.6: 3/2)',
    `got ${JSON.stringify(t)}`)
  t = adaptiveThresholds(1500)
  assert(t.tP > 3 && t.tP < T_P,
