...
export const ONBOARDING_TOPIC_MAP = Object.freeze({
  ...
  // news-heavy to ~50/50 by ADDING social verticals. None of the codes
  // above are removed — existing user profiles with old `followed_topics`
  // stay valid. The new codes are TikTok/IG/Threads-shaped: lifestyle,
  // creators, niche interests. Pipeline still needs to tag content with
  // matching `interest_tags` for these to retrieve anything; until the
  // V1.5 evergreen-content pipeline ships, news articles ABOUT these
  // topics will retrieve, which is acceptable seeding.

  // ── Home & living ──
  'home_design':          { tags: ['home design', 'interior design', 'home decor', 'furniture', 'home tour', 'minimalism', 'apartment'] },
  'productivity':         { tags: ['productivity', 'time management', 'gtd', 'note-taking', 'second brain', 'workflow', 'study'] },
  'wellness_meditation':  { tags: ['wellness', 'meditation', 'mindfulness', 'yoga', 'breathwork', 'self-care', 'mental wellness'] },
  'diy_crafts':           { tags: ['diy', 'crafts', 'handmade', 'maker', 'woodworking', 'knitting', 'crochet'] },

  // ── Creative & arts ──
  'dance':                { tags: ['dance', 'choreography', 'ballet', 'hip hop dance', 'tiktok dance', 'dance tutorial', 'street dance'] },
  'photography':          { tags: ['photography', 'photo tips', 'camera', 'lens', 'portrait photography', 'street photography', 'film photography'] },

  // ── Media tribes ──
  'indie_music':          { tags: ['indie music', 'indie rock', 'bedroom pop', 'lo-fi', 'singer-songwriter', 'indie folk', 'shoegaze'] },
  'podcasts':             { tags: ['podcasts', 'podcast', 'audio show', 'true crime podcast', 'interview show', 'podcast clip'] },
  'booktok':              { tags: ['booktok', 'book recommendations', 'reading', 'book review', 'literary fiction', 'romance novel', 'fantasy book'] },
  'reality_tv':           { tags: ['reality tv', 'reality show', 'love island', 'real housewives', 'survivor', 'big brother', 'dating show'] },
  'tv_recaps':            { tags: ['tv recap', 'episode discussion', 'spoiler thread', 'tv review', 'streaming show', 'series finale'] },

  // ── Niche social ──
  'memes_humor':          { tags: ['memes', 'humor', 'jokes', 'viral', 'funny videos', 'internet humor', 'satire'] },
  'relationships_dating': { tags: ['relationships', 'dating', 'dating advice', 'modern love', 'attachment styles', 'breakup'] },
  'finance_youth':        { tags: ['personal finance', 'budgeting', 'fire movement', 'investing for beginners', 'girl math', 'side hustle', 'financial literacy'] },
  'tech_creators':        { tags: ['tech creators', 'tech youtuber', 'tech reviewer', 'tech twitter', 'mkbhd', 'tech podcast', 'creator economy'] },
})
