...
import { serveTrinityFeed, phaseAwareSlotBudgets, engagementAwareSlotBudgets } from './trinityServe.js'
...
function testSlotBudgetSnapshot() {
  ...
  // Required keys in every phase output.
  const REQUIRED_KEYS = ['trinity-fresh', 'trinity-m-tier1', 'trinity-m-tier2', 'trinity-lt', 'explore']
