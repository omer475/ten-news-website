...
const RANKER_V1_CANARY_PCT = 10  // 10% canary by default. Bump after observation.
...
export async function serveTrinityFeed(supabase, opts) {
  ...
  if (slate.length < feedSize) {
    slate = backfillToTarget(slate, [trendingRanked, ltRanked, personalRanked, freshRanked, followRanked], feedSize)
  }
