...
export async function serveTrinityFeed(supabase, opts) {
  ...
  const mClusters  = trinityM(h1, h2, codebook.parentMap)
  ...
  // Top-up with trending if the joint pool is thin (e.g. fresh user, sparse clusters).
  if (candidates.length < feedSize * 3) {
