...
export async function serveTrinityFeed(supabase, opts) {
  ...
  const hourPrimaryBoosts = await loadHourPrimaryBoosts(supabase, userId)
  ...
  const rerankOpts = { recentEventIds, categoryMultipliers, publisherPenalties, hourPrimaryBoosts }
...
function rerank(candidates, opts = {}) {
  ...
  for (const a of candidates) {
    ...
    a._score = qualityNorm * recency * bucketBoost * stale * eventDemote * catMult * pubMult * seenMult * hourMult * freshMult
  }
