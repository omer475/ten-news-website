...
export async function serveTrinityFeed(supabase, opts) {
  ...
  // Trinity-LT excludes clusters Trinity-M already chose so the two retrievers
  // cover different ground (live 2026-05-02 12:53 had 7/10 = 70% cluster
  // overlap; joint candidate pool collapsed to 42).
