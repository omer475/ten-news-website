...
function testConstantsSane() {
  // 2026-05-19 (PR8): tuned 5000 → 2500. Matches TikTok Trinity exactly
  // (arxiv:2402.02842 §4 "length=2500"). 5000 doubled network payload and
  // caused slow loading; 2500 is still 2.5× legacy 1000 which is enough
  // headroom for heavy users (validated: primary 39 has 155 deep-reads
  // total in 60d — all fit in 2500).
  assert(ENGAGEMENT_BUFFER_LIMIT === 2500, 'buffer limit = 2500 (Trinity-exact)', `got ${ENGAGEMENT_BUFFER_LIMIT}`)
