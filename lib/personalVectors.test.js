...
function testConstantsSane() {
  // 2026-05-18: raised 1000 → 5000 to match Trinity 2500 / Pinterest 90d
  // and break the feedback-loop bug where the 1000-cap let recent bad-
  // serving drown out user's true long-term interests.
  assert(ENGAGEMENT_BUFFER_LIMIT === 5000, 'buffer limit = 5000 (Trinity/PinnerSage range)', `got ${ENGAGEMENT_BUFFER_LIMIT}`)
