...
// Note: trained ranker_v1_model.json has a positive learned coefficient on
// seen_count (it's partly leakage — see Phase 2.3.1). Low-seen scores can
// therefore be non-monotonic with seen_count. The end-to-end behavior that
// matters for ranking is: 5x-seen < unseen. Tighten back to strict
// monotonicity once leakage proxy is removed in future training.
