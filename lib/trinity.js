...
export function applyDiversityDiscount(slate, opts = {}) {
  ...
  const axes = opts.axes || [
    // 2026-05-17 — floor lowered 0.20 → 0.05. Audit found the 6th+ same-cluster
    // card still kept 20% of its raw score (800 → 160) — high enough to beat
    // unrelated cards. X's ImpressedImageClusterBasedListwiseRescoringProvider
    // uses pure (1-decay)^count with no floor. We keep a tiny 0.05 safety floor.
