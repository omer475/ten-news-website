...
export function trinityLT(h2, clusterStateMap, articleCountsBySecondary, rng = Math.random, opts = {}) {
  ...
  // genuinely cover different ground. Without this, M's pad and LT's
  // weighted-sample both prefer high-h² clusters and overlap heavily — live
  // 2026-05-02 12:53 had 7/10 (70%) cluster overlap and the joint candidate
  // pool collapsed to 42 articles.
