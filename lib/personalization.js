...
export const PERSONALIZATION_CONFIG = {
  // Country boosts (enough to surface relevant content without overwhelming raw scores)
  HOME_COUNTRY_BOOST: 180,
  FOLLOWED_COUNTRY_SINGLE_BOOST: 90,
  FOLLOWED_COUNTRY_MULTIPLE_BOOST: 120,

  // Topic boosts (enough so niche topics like F1/startups can compete)
  TOPIC_SINGLE_BOOST: 120,
  TOPIC_DOUBLE_BOOST: 170,
  TOPIC_TRIPLE_PLUS_BOOST: 210,
