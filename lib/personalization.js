...
export const PERSONALIZATION_CONFIG = {
  // Country boosts (high values so preferences actually compete with raw scores)
  HOME_COUNTRY_BOOST: 300,
  FOLLOWED_COUNTRY_SINGLE_BOOST: 150,
  FOLLOWED_COUNTRY_MULTIPLE_BOOST: 200,

  // Topic boosts (high values so niche topics like F1/startups can surface)
  TOPIC_SINGLE_BOOST: 200,
  TOPIC_DOUBLE_BOOST: 280,
  TOPIC_TRIPLE_PLUS_BOOST: 350,
