...
export const TOPICS = [
  ...
  // Social-platform expansion (2026-05-11). Codes mirror lib/coldStart.js
  // ONBOARDING_TOPIC_MAP and iOS TopicCategories.all exactly so signals
  // flow through the algorithm's onboarding floor. Pre-existing short
  // web codes (politics, ai, football\u2026) stay valid for back-compat.
  { code: 'home_design',          name: 'Home Design',          icon: '\u{1F3E0}', category: 'social' },
  { code: 'productivity',         name: 'Productivity',         icon: '\u2705',     category: 'social' },
  { code: 'wellness_meditation',  name: 'Wellness',             icon: '\u{1F33F}', category: 'social' },
  { code: 'diy_crafts',           name: 'DIY & Crafts',         icon: '\u{1F528}', category: 'social' },
  { code: 'dance',                name: 'Dance',                icon: '\u{1F483}', category: 'social' },
  { code: 'photography',          name: 'Photography',          icon: '\u{1F4F7}', category: 'social' },
  { code: 'indie_music',          name: 'Indie Music',          icon: '\u{1F3B8}', category: 'social' },
  { code: 'podcasts',             name: 'Podcasts',             icon: '\u{1F3A7}', category: 'social' },
  { code: 'booktok',              name: 'BookTok',              icon: '\u{1F4DA}', category: 'social' },
  { code: 'reality_tv',           name: 'Reality TV',           icon: '\u{1F4FA}', category: 'social' },
  { code: 'tv_recaps',            name: 'TV Recaps',            icon: '\u{1F39E}\uFE0F', category: 'social' },
  { code: 'memes_humor',          name: 'Memes & Humor',        icon: '\u{1F602}', category: 'social' },
  { code: 'relationships_dating', name: 'Relationships',        icon: '\u{1F495}', category: 'social' },
  { code: 'finance_youth',        name: 'Personal Finance',     icon: '\u{1F4B0}', category: 'social' },
  { code: 'tech_creators',        name: 'Tech Creators',        icon: '\u{1F4F1}', category: 'social' },
];
