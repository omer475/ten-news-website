...
export const PERSONALIZATION_CONFIG = {
  ...
  HOME_COUNTRY_BOOST: 500,
  FOLLOWED_COUNTRY_SINGLE_BOOST: 350,
  FOLLOWED_COUNTRY_MULTIPLE_BOOST: 400,

  // Topic boosts (scaled by AI topic relevance score 0-100)
  TOPIC_SINGLE_BOOST: 400,
  TOPIC_DOUBLE_BOOST: 450,
  TOPIC_TRIPLE_PLUS_BOOST: 500,
