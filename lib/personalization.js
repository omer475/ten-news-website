...
export const COUNTRIES = [
  ...
  { code: 'taiwan', name: 'Taiwan', flag: '\u{1F1F9}\u{1F1FC}', region: 'asia' },
  
  // Middle East
  { code: 'israel', name: 'Israel', flag: '\u{1F1EE}\u{1F1F1}', region: 'middle_east' },
  { code: 'saudi_arabia', name: 'Saudi Arabia', flag: '\u{1F1F8}\u{1F1E6}', region: 'middle_east' },
  { code: 'iran', name: 'Iran', flag: '\u{1F1EE}\u{1F1F7}', region: 'middle_east' },
  { code: 'uae', name: 'UAE', flag: '\u{1F1E6}\u{1F1EA}', region: 'middle_east' },
  
  // Americas
  { code: 'canada', name: 'Canada', flag: '\u{1F1E8}\u{1F1E6}', region: 'americas' },
  { code: 'brazil', name: 'Brazil', flag: '\u{1F1E7}\u{1F1F7}', region: 'americas' },
  { code: 'mexico', name: 'Mexico', flag: '\u{1F1F2}\u{1F1FD}', region: 'americas' },
