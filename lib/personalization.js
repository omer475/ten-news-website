...
export const COUNTRIES = [
  ...
  { code: 'ireland', name: 'Ireland', flag: '\u{1F1EE}\u{1F1EA}', region: 'europe' },
  
  // Asia
  { code: 'india', name: 'India', flag: '\u{1F1EE}\u{1F1F3}', region: 'asia' },
  { code: 'japan', name: 'Japan', flag: '\u{1F1EF}\u{1F1F5}', region: 'asia' },
  { code: 'south_korea', name: 'South Korea', flag: '\u{1F1F0}\u{1F1F7}', region: 'asia' },
  { code: 'pakistan', name: 'Pakistan', flag: '\u{1F1F5}\u{1F1F0}', region: 'asia' },
  { code: 'singapore', name: 'Singapore', flag: '\u{1F1F8}\u{1F1EC}', region: 'asia' },
  ...
  { code: 'brazil', name: 'Brazil', flag: '\u{1F1E7}\u{1F1F7}', region: 'americas' },
  
  // Africa
  { code: 'nigeria', name: 'Nigeria', flag: '\u{1F1F3}\u{1F1EC}', region: 'africa' },
  { code: 'south_africa', name: 'South Africa', flag: '\u{1F1FF}\u{1F1E6}', region: 'africa' },
...
export const PERSONALIZATION_CONFIG = {
  // Country boosts
  HOME_COUNTRY_BOOST: 150,
  FOLLOWED_COUNTRY_SINGLE_BOOST: 75,
  FOLLOWED_COUNTRY_MULTIPLE_BOOST: 100,
  
  // Topic boosts
  TOPIC_SINGLE_BOOST: 50,
  TOPIC_DOUBLE_BOOST: 80,
  TOPIC_TRIPLE_PLUS_BOOST: 100,
...
export function calculateFinalScore(article, user) {
  ...
  // 2. FOLLOWED COUNTRIES BOOST (+75 for 1, +100 for 2+)
