 ...
 * Collapsed: a distinctive editorial card (kicker + hero + headline + dek).
 * Tapping it expands the full piece INLINE with a smooth height animation
 * (the feed below simply flows down); tapping again collapses it.
 */
export default function DeepDiveCard({ deepDive, isDark = false }) {
