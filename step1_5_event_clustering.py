...
class ClusteringConfig:
    ...
    MIN_TITLE_SIMILARITY = 0.50  # Minimum 50% title similarity even with keyword match
...
def is_same_event(article: Dict, cluster: Dict, cluster_sources: List[Dict], debug: bool = False) -> Dict:
    ...
    3. Title similarity >= 50% AND (5+ shared keywords OR 2+ shared entities)
    ...
    # Check 3: Keyword/Entity overlap (ONLY if title similarity >= 50%)
