...
Run this in Google Colab to install dependencies and execute the company scraper

🚨 IMPORTANT: SCROLL DOWN TO LINE 344 TO ADD YOUR CLAUDE API KEY! 🚨
Look for: CLAUDE_API_KEY = "YOUR_CLAUDE_API_KEY"
"""
...
CLAUDE_API_KEY = "your-api-key-here"  # ✅ YOUR API KEY IS NOW ADDED!
# ⬆️⬆️⬆️ REPLACE "YOUR_CLAUDE_API_KEY" WITH YOUR ACTUAL API KEY ⬆️⬆️⬆️

def run_scraper(api_key: str, test_mode: bool = False):
    """
    ...
    # Initialize scraper
    scraper = CompanyScraper(api_key)
    ...
    try:
        ...
        if companies_data:
            ...
            print(f"\n⬇️ To download the file in Colab, run:")
...
# Test mode (processes only 5 companies)
print("🧪 To run in TEST MODE (5 companies only):")
print("run_scraper(CLAUDE_API_KEY, test_mode=True)")
print()
print("🚀 To run FULL SCRAPING:")
print("run_scraper(CLAUDE_API_KEY, test_mode=False)")
print()
print("⚠️  Remember to replace CLAUDE_API_KEY with your actual API key first!")
