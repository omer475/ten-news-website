      ...
      <style>{`
        * {
        ...
        .header {
          ...
          left: 0;
          right: 0;
          /* Height includes safe area inset for notch/status bar */
          height: calc(60px + env(safe-area-inset-top, 0px));
          /* Semi-transparent header overlays on top of image */
          ...
          /* Padding accounts for safe areas: top for notch, sides for landscape */
        ...
        .news-item:hover {
          /* No hover effect needed for full-width layout */
        }
        ...
        .progress-indicator {
          position: fixed;
          /* Right position accounts for safe area in landscape */
        ...
        .scroll-hint {
          position: absolute;
          /* Bottom position accounts for home indicator safe area */
        ...
        @media (max-width: 768px) {
          ...
          .opening-container {
            /* Account for safe areas in opening container */
            padding: 0 calc(20px + env(safe-area-inset-right, 0px)) 0 calc(20px + env(safe-area-inset-left, 0px));
            min-height: calc(100vh - 120px - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px));
          }
          
          .scroll-hint {
            /* Bottom position with safe area for home indicator */
