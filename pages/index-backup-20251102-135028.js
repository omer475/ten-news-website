                ...
                <div className="news-grid" style={{ overflow: 'hidden', padding: 0, margin: 0 }}>
                    ...
                    {/* Content Area - Starts After Image */}
                      ...
                      <div style={{
                        ...
                        {/* Time Since Published - Minimal Design - Always on Left - Fixed */}
                        <div style={{
                          fontSize: '11px',
                          fontWeight: '400',
                          color: '#86868b',
                        ...
                        {/* Dynamic Information Switch - Only show if multiple information types available - Always on Right - Fixed */}
