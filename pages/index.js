...
export default function Home() {
  ...
  const [articleBlurColors, setArticleBlurColors] = useState({}); // Fixed palette colors for blur backgrounds
                ...
                <div className="news-grid" style={{ overflow: 'hidden', padding: 0, margin: 0 }}>
                  ...
                  <div className="news-item" style={{ overflow: 'visible', padding: 0, position: 'relative' }} onClick={() => {
                    ...
                    <div style={{
                      ...
                      overflow: 'hidden',
                      pointerEvents: 'none',
                      boxShadow: articleBlurColors[index] ? `0 8px 24px ${articleBlurColors[index]}40` : "0 8px 24px rgba(0, 0, 0, 0.25)",
                      ...
                      <div style={{
                        ...
                        background: articleBlurColors[index] 
                          ? `linear-gradient(to bottom, 
                              ${articleBlurColors[index]}26 0%, 
                              ${articleBlurColors[index]}40 10%, 
                              ${articleBlurColors[index]}73 30%, 
                              ${articleBlurColors[index]}A6 50%, 
                              ${articleBlurColors[index]}D9 70%, 
                              ${articleBlurColors[index]}F2 80%, 
                              ${articleBlurColors[index]}FA 90%, 
                              ${articleBlurColors[index]}FF 95%, 
                              ${articleBlurColors[index]}FF 100%)`
                        ...
                        }}>{renderTitleWithHighlight(story.title, articleBlurColors[index], story.category)}</h3>
                        </div>
                      )}
                    </div>
                              ...
                              {story.summary_bullets && story.summary_bullets.length > 0 ? (
                                <ul style={{
                                  ...
                                  {story.summary_bullets.map((bullet, i) => (
                                    ...
                                    {renderBoldText(bullet, articleBlurColors[index], story.category)}
                                    </li>
                                  ))}
                                </ul>
                              ) : (
